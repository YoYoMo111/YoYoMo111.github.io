...
//var map = t.ImageUtils.loadTexture("images/sprites.png");
//var spriteMaterial = new t.SpriteMaterial( { map: map } );
var bullets = [];//bullets texture here!

var sphereMaterial = new t.MeshBasicMaterial({color: 0x333333};//原material {color: 0x333333}
var sphereGeo = new t.SphereGeometry(2, 6, 6);//原geo
